...
public class EasyInnerOffLineController {
    ...
    public void coletarBilhetes() 
    {
        ...
        try 
        {
            ...
            if ((boolean) InfoInner.get("InnerAcesso")) {
        ...
        try {
            ...
            if (uiOffLine.jChkBio.isSelected()) {
                ...
                if (InfoInner.get("LinhaInner").equals("Inner Acesso")
                    ...
                    retorno = offLineService.configurarBio(numInner, (uiOffLine.jChkIdentificacao.isSelected() ? 1 : 0), (uiOffLine.jChkVerificacao.isSelected() ? 1 : 0), 10);
