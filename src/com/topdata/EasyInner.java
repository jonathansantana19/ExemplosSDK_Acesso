...
//</editor-fold>
    ...
    */
    ...
    public native int IncluirUsuarioSemDigitalBioInnerAcesso(String Cartao);
     ...
     * @return
     */
    public native int EnviarListaUsuariosSemDigitalBioVariavel(int Inner, int QtdDigitos);
    ...
    public native int ConfigurarAjustesSensibilidadeBio(int Inner, byte Ganho, byte Brilho, byte Contraste);
   
    public native int ConfigurarAjustesQualidadeBio(int Inner, byte Registro, byte Verificacao);
    
    public native int ConfigurarAjustesSegurancaBio(int Inner, byte Identificacao, byte Verificacao);
    
    public native int ConfigurarCapturaAdaptativaBio(int Inner, byte Capturar, byte Total, byte Tempo);
    
    public native int ConfigurarFiltroBio(int Inner, byte Habilitar);
    
    public native int ConfigurarTimeoutIdentificacao(byte TimeoutIdentificacao);

    public native int ConfigurarNivelLFD(byte NivelLFD);    
    
    public native int EnviarAjustesBio(int Inner);    
